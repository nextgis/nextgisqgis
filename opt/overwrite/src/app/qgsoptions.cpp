    ...
    , mSettings( nullptr )
{
  ...
  //Network timeout
  mNetworkTimeoutSpinBox->setValue( mSettings->value( "/qgis/networkAndProxy/networkTimeout", "300000" ).toInt() );
  ...
  mCacheSize->setValue( mSettings->value( "cache/size", 50 * 1024 * 1024 ).toInt() / 1024 );
...
#ifdef Q_OS_MAC
  mSettings->setValue( "cache/size", mCacheSize->value() * 1024 );
#else
