/********************************************************************************
** Form generated from reading UI file 'qgstiledscenelayerpropertiesbase.ui'
**
...
#ifndef UI_QGSTILEDSCENELAYERPROPERTIESBASE_H
#define UI_QGSTILEDSCENELAYERPROPERTIESBASE_H
...
class Ui_QgsTiledSceneLayerPropertiesBase
{
public:
    ...
    void setupUi(QDialog *QgsTiledSceneLayerPropertiesBase)
    {
        if (QgsTiledSceneLayerPropertiesBase->objectName().isEmpty())
            QgsTiledSceneLayerPropertiesBase->setObjectName(QString::fromUtf8("QgsTiledSceneLayerPropertiesBase"));
        QgsTiledSceneLayerPropertiesBase->resize(815, 557);
        QgsTiledSceneLayerPropertiesBase->setMinimumSize(QSize(700, 0));
        verticalLayout = new QVBoxLayout(QgsTiledSceneLayerPropertiesBase);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        verticalLayout->setContentsMargins(0, -1, 0, -1);
        mOptionsSplitter = new QSplitter(QgsTiledSceneLayerPropertiesBase);
        ...
        mButtonBoxFrame = new QFrame(QgsTiledSceneLayerPropertiesBase);
        ...
        retranslateUi(QgsTiledSceneLayerPropertiesBase);
        QObject::connect(mOptionsListWidget, SIGNAL(currentRowChanged(int)), mOptionsStackedWidget, SLOT(setCurrentIndex(int)));

        mOptionsStackedWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(QgsTiledSceneLayerPropertiesBase);
    } // setupUi

    void retranslateUi(QDialog *QgsTiledSceneLayerPropertiesBase)
    {
        QgsTiledSceneLayerPropertiesBase->setWindowTitle(QCoreApplication::translate("QgsTiledSceneLayerPropertiesBase", "Vector Tile Layer Properties", nullptr));
        ...
        ___qlistwidgetitem->setText(QCoreApplication::translate("QgsTiledSceneLayerPropertiesBase", "Information", nullptr));
#if QT_CONFIG(tooltip)
        ___qlistwidgetitem->setToolTip(QCoreApplication::translate("QgsTiledSceneLayerPropertiesBase", "Information", nullptr));
#endif // QT_CONFIG(tooltip)
        QListWidgetItem *___qlistwidgetitem1 = mOptionsListWidget->item(1);
        ___qlistwidgetitem1->setText(QCoreApplication::translate("QgsTiledSceneLayerPropertiesBase", "Source", nullptr));
#if QT_CONFIG(tooltip)
        ___qlistwidgetitem1->setToolTip(QCoreApplication::translate("QgsTiledSceneLayerPropertiesBase", "Source", nullptr));
#endif // QT_CONFIG(tooltip)
        QListWidgetItem *___qlistwidgetitem2 = mOptionsListWidget->item(2);
        ___qlistwidgetitem2->setText(QCoreApplication::translate("QgsTiledSceneLayerPropertiesBase", "Rendering", nullptr));
#if QT_CONFIG(tooltip)
        ___qlistwidgetitem2->setToolTip(QCoreApplication::translate("QgsTiledSceneLayerPropertiesBase", "Rendering", nullptr));
#endif // QT_CONFIG(tooltip)
        QListWidgetItem *___qlistwidgetitem3 = mOptionsListWidget->item(3);
        ___qlistwidgetitem3->setText(QCoreApplication::translate("QgsTiledSceneLayerPropertiesBase", "Metadata", nullptr));
#if QT_CONFIG(tooltip)
        ___qlistwidgetitem3->setToolTip(QCoreApplication::translate("QgsTiledSceneLayerPropertiesBase", "Metadata", nullptr));
#endif // QT_CONFIG(tooltip)
        mOptionsListWidget->setSortingEnabled(__sortingEnabled);

        groupBox_60->setTitle(QCoreApplication::translate("QgsTiledSceneLayerPropertiesBase", "Settings", nullptr));
        label_6->setText(QCoreApplication::translate("QgsTiledSceneLayerPropertiesBase", "Layer name", nullptr));
        mCrsGroupBox->setTitle(QCoreApplication::translate("QgsTiledSceneLayerPropertiesBase", "Assigned Coordinate Reference System (CRS)", nullptr));
        label_7->setText(QCoreApplication::translate("QgsTiledSceneLayerPropertiesBase", "<html><head/><body><p><span style=\" font-weight:600;\">Changing this option does not modify the original data source or perform any reprojection of data. Rather, it can be used to override the layer's CRS within this project if it could not be detected or has been incorrectly detected.</span></p></body></html>", nullptr));
        chkUseScaleDependentRendering->setTitle(QCoreApplication::translate("QgsTiledSceneLayerPropertiesBase", "Scale Dependent Visibility", nullptr));
#if QT_CONFIG(tooltip)
...
namespace Ui {
    class QgsTiledSceneLayerPropertiesBase: public Ui_QgsTiledSceneLayerPropertiesBase {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_QGSTILEDSCENELAYERPROPERTIESBASE_H
