...
{
  setupUi( this );
  NGAuthOptions *nextGisOptionsPage = findChild<NGAuthOptions *>( QStringLiteral( "mOptionsPageNextGIS" ) );
  ...
  if ( nextGisOptionsPage )
  {
    nextGisOptionsPage->init( mSettings );
  }
  ...
  const QStringList helpPathList = mSettings->value( QStringLiteral( "help/helpSearchPath" ), "https://docs.nextgis.ru/docs_ngqgis/source/index.html" ).toStringList();
