...
{
    qDebug() << "QgsSimpleMarkerSymbolLayerBase::startRender";
...
{
    qDebug() << "QgsSimpleMarkerSymbolLayerBase::bounds";
  bool hasDataDefinedSize = false;
  double scaledSize = calculateSize( context, hasDataDefinedSize );
...
{
    qDebug() << "QgsSimpleMarkerSymbolLayer::startRender";
...
{
    qDebug() << "QgsSimpleMarkerSymbolLayer::bounds" << point.x() << point.y();
...
{
    qDebug() << "QgsFilledMarkerSymbolLayer::startRender";
  if ( mFill )
  {
...
{
    qDebug() << "QgsSvgMarkerSymbolLayer::startRender";
...
{
    qDebug() << "QgsSvgMarkerSymbolLayer::bounds";
  bool hasDataDefinedSize = false;
  double scaledSize = calculateSize( context, hasDataDefinedSize );
  scaledSize = context.renderContext().convertToPainterUnits( scaledSize, mSizeUnit, mSizeMapUnitScale );
