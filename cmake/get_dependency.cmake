...
if(BINARY_URL)
    ...
    elseif(OSX_FRAMEWORK)
        ...
        endforeach()
        file(GLOB_RECURSE _DYLIBS LIST_DIRECTORIES true ${DST_PATH}/${BINARY_NAME}/Library/Frameworks/*.dylib*)
        foreach(_DYLIB ${_DYLIBS})
            get_filename_component(DYLIB_NAME ${_DYLIB} NAME)
            if(DYLIB_NAME MATCHES ".*dylib*")
                execute_process(
                    COMMAND ${CMAKE_COMMAND} -E rename ${_DYLIB} ${DST_PATH}/${DYLIB_NAME} 
                    WORKING_DIRECTORY ${DST_PATH}
                )
            endif()
        endforeach()
