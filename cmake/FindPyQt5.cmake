...
ELSE(EXISTS PYQT5_VERSION_STR)
  ...
  IF(SIP_BUILD_EXECUTABLE)
    ...
    ELSE(_pyqt5_metadata)
      EXECUTE_PROCESS(COMMAND ${Python3_EXECUTABLE} -c "from PyQt5.QtCore import PYQT_VERSION_STR; print(PYQT_VERSION_STR)" OUTPUT_VARIABLE PYQT5_VERSION_STR)
    ENDIF(_pyqt5_metadata)

    IF(PYQT5_VERSION_STR)
      EXECUTE_PROCESS(COMMAND ${Python3_EXECUTABLE} -c "import PyQt5.QtCore; import os; print(os.path.dirname(PyQt5.__file__))" OUTPUT_VARIABLE PYQT5_MOD_DIR OUTPUT_STRIP_TRAILING_WHITESPACE)
  ...
  ELSE(SIP_BUILD_EXECUTABLE)
    ...
    EXECUTE_PROCESS(COMMAND ${Python3_EXECUTABLE} ${_find_pyqt5_py} OUTPUT_VARIABLE pyqt_config)
    IF(pyqt_config)
